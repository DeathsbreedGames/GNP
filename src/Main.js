...
DeathsbreedGames.game.state.add('InstructionsMenu', DeathsbreedGames.InstructionsMenu);
DeathsbreedGames.game.state.add('CreditsMenu', DeathsbreedGames.CreditsMenu);
